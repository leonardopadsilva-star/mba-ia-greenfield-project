...
describe('JwtAuthGuard', () => {
  ...
  it('on @Public() routes, attaches the payload when a valid token is present', async () => {
    mockReflector.getAllAndOverride.mockReturnValue(true);
  ...
  it('on @Public() routes, proceeds unauthenticated (no throw) with an invalid token', async () => {
    mockReflector.getAllAndOverride.mockReturnValue(true);
    const request: Record<string, unknown> = {
